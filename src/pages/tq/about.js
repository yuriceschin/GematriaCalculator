...
export default () => (
  <Layout>
    ...
    <p>
      ...
      Known as Trigrammaton Qabalah, or TQ, this system is based on one of the
      Holy Books of Thelema written by Aleister Crowley in 1907, called Liber
      Trigrammaton, sub figura XXVII -- Being the Book of the Mutations of the
      Tao with the Yin and the Yang. Liber Trigrammaton (aka Liber XXVII) was
      called by Crowley "the ultimate foundation of the highest theoretical
      qabalah". In Liber XXVII are 27 three-line diagrams known as 'trigrams',
      which are composed of a solid line representing the Yang, a broken line
      representing the Yin, and a point representing the Tao. Crowley later
      ...
      with Liber Trigrammaton. By considering the numerical value of the 27
      trigrams as expressions in Base 3, (or ternary), and then transferring
      those values to the letters attributed by Crowley to the trigrams, a
      system of English gematria is created. Further use is made of the trigrams
      to create a true qabalah in the sense of the definition provided by Jake
