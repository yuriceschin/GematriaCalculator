...
export default class TQCalculator extends React.Component {
  constructor(props) {
    super(props);
    this.state = { result: 0, data: [], correspondences: [],searchedWord: [] };
    this.timeout = 0;
  ...
  componentDidMount() {
    ...
    this.setState({ result: 0, correspondences:[], data: this.props.data.allCorrespondencesCsv.edges });
  ...
  componentWillUnmount() {
    this.setState({ result: 0,data:[],correspondences:[],searchedWord: [] });
  ...
  handleChange(event) {
    this.setState({ result: 0, correspondences: [] });
