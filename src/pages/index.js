...
export default () => (
  <Layout>
    ...
    <h3>Info</h3>
    <h4>Trigrammaton English Gematria values</h4>
...
N=24 <br/>O=10  P=4  Q=16  R=14  S=15  T=9  U=25  V=22  W=8  X=6  Y=18  Z=19  &=26</p>
	...
	<a href="https://en.wikipedia.org/wiki/English_Qabalah#Trigrammaton_Qabalah_(TQ)">
		<blockquote cite="https://en.wikipedia.org/wiki/English_Qabalah#Trigrammaton_Qabalah_(TQ)">Wikipedia</blockquote>
	</a>
